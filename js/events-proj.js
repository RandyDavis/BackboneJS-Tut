...
//});
//
//var vehicle = new Vehicle({ registrationNumber: "DR4-XKY", "dataColor": "green" });
//
//var vehicles = new Vehicles([
//  new Vehicle({ id: 1, registrationNumber: "XXX-XX4",  "dataColor": "yellow" }),
//  new Vehicle({ id: 2, registrationNumber: "YH5-YX4",  "dataColor": "blue" }),
//  new Vehicle({ id: 3, registrationNumber: "H73-XJ1",  "dataColor": "red" }),
//  new Vehicle({ id: 4, registrationNumber: "TY0-XD4",  "dataColor": "black" })
//]);
//
...
var vehicle = new Vehicle({ registrationNumber: "GOF-AST", dataColor: "yellow" });

var vehicles = new Vehicles([
	new Vehicle({ id: 1, registrationNumber: "FB8-11A", dataColor: "white" }),
	new Vehicle({ id: 2, registrationNumber: "FBR-POA", dataColor: "blue" }),
	new Vehicle({ id: 3, registrationNumber: "XBE-MAN", dataColor: "pink" }),
	new Vehicle({ id: 4, registrationNumber: "3GP-01M", dataColor: "navy" })
]);
